...
| [0006](./0006-test-last-statt-tdd.md) | Test-Last statt Test-First (TDD) | Form der Schnittstelle bei explorativem UI-Code vorab unklar — Test-First würde raten statt entwerfen |
